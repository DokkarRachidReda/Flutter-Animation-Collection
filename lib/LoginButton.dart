...
/*
 the button have three main states
  1- beffor clicking 
  2- while checking the user input , it's a CircularProgressIndicator
  3- it's like a message ,it desplay an icon and change the color to the red if the inpus are false

  ps: the animation is for all the widget , i used animatedContainer to animate the button , much easier
